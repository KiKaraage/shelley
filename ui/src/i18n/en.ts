...
export const en: TranslationKeys = {
  ...
  gitGraph: "Git Graph",
  terminal: "Terminal",
  archiveConversation: "Settle Conversation",
  exportConversation: "Export Conversation",
  exportToGist: "Export to Gist",
  updateGist: "Update Gist",
  gistNeedsName: "Session must have a name (not 'Untitled')",
  gistGhNotInstalled: "GitHub CLI (gh) not found — install it first",
  gistGhNotAuth: "Not logged in to GitHub — run: gh auth login",
  ...
  archiveConversationAction: "Settle Conversation",
  archiveCurrentConversation: "Settle the current conversation",
  ...
  skippedModelsCount: "skipped (already exist).",
  done: "Done",
