...
export const zhCN: TranslationKeys = {
  ...
  gitGraph: "Git 图",
  terminal: "终端",
  archiveConversation: "整理对话",
  exportConversation: "导出对话",
  exportToGist: "导出到 Gist",
  updateGist: "更新 Gist",
  gistNeedsName: "会话必须有名称（不能是 'Untitled'）",
  gistGhNotInstalled: "未找到 GitHub CLI (gh) — 请先安装",
  gistGhNotAuth: "未登录 GitHub — 运行: gh auth login",
  ...
  archiveConversationAction: "整理对话",
  archiveCurrentConversation: "整理当前对话",
  ...
  // Conversation Drawer
  archived: "已整理",
  noArchivedConversations: "没有已整理的对话",
  ...
  contextWindow: "上下文窗口",
  contextWindowHint: "上下文窗口总大小 (0 = 从模型名自动检测).",
  maxOutputTokensHint: "每次回复的最大输出令牌数 (0 = 200k 默认).",
