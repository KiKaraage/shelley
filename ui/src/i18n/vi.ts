...
export const vi: TranslationKeys = {
  ...
  terminal: "Terminal",
  archiveConversation: "Lưu trữ hội thoại",
  exportConversation: "Xuất hội thoại",
  exportToGist: "Xuất sang Gist",
  updateGist: "Cập nhật Gist",
  gistNeedsName: "Phiên phải có tên (không phải 'Untitled')",
  gistGhNotInstalled: "Không tìm thấy GitHub CLI (gh) — hãy cài đặt trước",
  gistGhNotAuth: "Chưa đăng nhập GitHub — chạy: gh auth login",
  ...
  archiveConversationAction: "Lưu trữ hội thoại",
  ...
  // Conversation Drawer
  archived: "Đã lưu trữ",
  noArchivedConversations: "Chưa có hội thoại đã lưu trữ",
  ...
  maxOutputTokens: "Đầu ra tối đa",
  contextWindow: "Cửa sổ ngữ cảnh",
  contextWindowHint: "Tổng kích thước cửa sổ ngữ cảnh (0 = tự động).",
  maxOutputTokensHint: "Số token đầu ra tối đa mỗi phản hồi (0 = 200k mặc định).",
