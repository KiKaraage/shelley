...
export const upgoer5: TranslationKeys = {
  ...
  exportToGist: "Send To Gist Thing",
  updateGist: "Update Gist Thing",
  gistNeedsName: "Talk Thing needs a name (not 'Untitled')",
  gistGhNotInstalled: "GitHub thing not found — put it on first",
  gistGhNotAuth: "Not signed into GitHub — do: gh auth login",
  ...
  maxOutputTokens: "Most words it can say back",
  contextWindow: "Word Box",
  contextWindowHint: "How big the word box is (0 = guess).",
  maxOutputTokensHint: "Most words it can say back at once (0 = 200k).",
