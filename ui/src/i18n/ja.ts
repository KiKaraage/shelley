...
export const ja: TranslationKeys = {
  ...
  gitGraph: "Git グラフ",
  terminal: "ターミナル",
  archiveConversation: "会話を整理",
  exportConversation: "会話をエクスポート",
  exportToGist: "Gistにエクスポート",
  updateGist: "Gistを更新",
  gistNeedsName: "セッション名を設定してください（'Untitled'は不可）",
  gistGhNotInstalled: "GitHub CLI (gh) が見つかりません — まずインストールしてください",
  gistGhNotAuth: "GitHubにログインしていません — gh auth login を実行してください",
  ...
  archiveConversationAction: "会話を整理",
  archiveCurrentConversation: "現在の会話を整理する",
  ...
  contextWindowHint: "コンテキストウィンドウの合計サイズ (0 = モデル名から自動検出).",
  maxOutputTokensHint: "応答あたりの最大出力トークン数 (0 = 200k デフォルト).",
