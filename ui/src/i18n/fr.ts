...
export const fr: TranslationKeys = {
  ...
  gitGraph: "Graphe Git",
  terminal: "Terminal",
  archiveConversation: "Classer la conversation",
  exportConversation: "Exporter la conversation",
  exportToGist: "Exporter vers Gist",
  updateGist: "Mettre à jour le Gist",
  gistNeedsName: "La session doit avoir un nom (pas 'Untitled')",
  gistGhNotInstalled: "GitHub CLI (gh) introuvable — installez-le d'abord",
  gistGhNotAuth: "Pas connecté à GitHub — exécutez : gh auth login",
  ...
  archiveConversationAction: "Classer la conversation",
  archiveCurrentConversation: "Classer la conversation en cours",
  ...
  // Conversation Drawer
  archived: "Classées",
  noArchivedConversations: "Aucune conversation classée",
  ...
  viewArchived: "Voir les classées",
  rename: "Renommer",
