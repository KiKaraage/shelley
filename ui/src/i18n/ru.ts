...
export const ru: TranslationKeys = {
  ...
  gitGraph: "Граф Git",
  terminal: "Терминал",
  archiveConversation: "Отложить диалог",
  exportConversation: "Экспортировать диалог",
  exportToGist: "Экспорт в Gist",
  updateGist: "Обновить Gist",
  gistNeedsName: "Сессия должна иметь имя (не 'Untitled')",
  gistGhNotInstalled: "GitHub CLI (gh) не найден — установите его",
  gistGhNotAuth: "Не вошли в GitHub — выполните: gh auth login",
  ...
  archiveConversationAction: "Отложить диалог",
  archiveCurrentConversation: "Отложить текущий диалог",
  ...
  // Conversation Drawer
  archived: "Отложенные",
  noArchivedConversations: "Нет отложенных диалогов",
  ...
  viewArchived: "Показать отложенные",
