...
export const es: TranslationKeys = {
  ...
  terminal: "Terminal",
  archiveConversation: "Clasificar conversación",
  exportConversation: "Exportar conversación",
  exportToGist: "Exportar a Gist",
  updateGist: "Actualizar Gist",
  gistNeedsName: "La sesión debe tener un nombre (no 'Untitled')",
  gistGhNotInstalled: "GitHub CLI (gh) no encontrado — instálalo primero",
  gistGhNotAuth: "No conectado a GitHub — ejecuta: gh auth login",
  ...
  archiveConversationAction: "Clasificar conversación",
  archiveCurrentConversation: "Clasificar la conversación actual",
  ...
  // Conversation Drawer
  archived: "Clasificadas",
  noArchivedConversations: "No hay conversaciones clasificadas",
...
delete_: "Eliminar",
  ...
  taskTitleLabel: "Task",
  taskTitleRequired: "Task is required.",
  ...
  idleItems: "idle items",
  currentlyHandled: "currently handled",
  tasksDone: "tasks done",
  nothingIdle: "Nothing idle",
  nothingHandled: "Nothing handled",
  nothingDone: "Nothing done",
  noTasksYet: "No tasks yet",
  noTasksYetHint: "Tasks you create will show up here.",
  createFirstTask: "＋ Create your first task",
  nothingHere: "Nothing here",
  noTasksIn: "No tasks in",
  all: "All",
  noDir: "No dir",
  editTask: "Edit",
  ...
  noDirOptions: "No recent directories",
