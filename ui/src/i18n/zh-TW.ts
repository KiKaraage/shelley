...
export const zhTW: TranslationKeys = {
  ...
  gitGraph: "Git 圖",
  terminal: "終端機",
  archiveConversation: "整理對話",
  exportConversation: "匯出對話",
  exportToGist: "匯出到 Gist",
  updateGist: "更新 Gist",
  gistNeedsName: "對話必須有名稱（不能是 'Untitled'）",
  gistGhNotInstalled: "找不到 GitHub CLI (gh) — 請先安裝",
  gistGhNotAuth: "未登入 GitHub — 執行: gh auth login",
  ...
  archiveConversationAction: "整理對話",
  archiveCurrentConversation: "整理目前對話",
  ...
  // Conversation Drawer
  archived: "已整理",
  noArchivedConversations: "沒有已整理的對話",
  ...
  contextWindow: "上下文視窗",
  contextWindowHint: "上下文視窗總大小 (0 = 從模型名自動偵測).",
  maxOutputTokensHint: "每次回覆的最大輸出權杖數 (0 = 200k 預設).",
